            ...
            <div class="row">
                <div class="col-12">
                    <div class="sign__content">
                        <form method="POST" action="{{ route('addUser') }}" class="sign__form">
                            @csrf
                            ...
                            <div class="sign__group">
                                <input type="text" id="name" class="sign__input @error('name') is-invalid @enderror"
                            ...
                            <div class="sign__group">
                                <input type="email" id="email"
                                    class="sign__input @error('email') is-invalid @enderror" placeholder="Email"
                            ...
                            <div class="sign__group">
                                <input type="password" id="password-confirm" class="sign__input"
