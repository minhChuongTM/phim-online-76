            ...
            <div class="col-12">
                <ul class="header__nav">
                    <li class="header__nav-item">
                        <a class="header__nav-link" href="{{ route('home')}}" role="button" id="">Trang Chủ</a>
                    </li>
                    <li class="header__nav-item">
                        <a class="header__nav-link" href="{{route('category')}}" role="button" id="">Phim Mới</a>
                    </li>
                    {{-- <li class="header__nav-item">
                        <a class="header__nav-link" href="#" role="button" id="dropdownMenu1"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Năm <svg
                        ...
                        <ul class="dropdown-menu header__nav-menu" aria-labelledby="dropdownMenu1">
                            <li><a href="catalog.html">Phim 2020</a></li>
                            <li><a href="category.html">Năm 2019</a></li>
                            <li><a href="category2.html">Category style 2</a></li>
                            <li><a href="details.html">Năm 2018</a></li>
                        </ul>
                    </li> --}}
                    <li class="header__nav-item">
                        <a class="header__nav-link" href="#" role="button" id="dropdownMenu1"
                        ...
                        <ul class="dropdown-menu header__nav-menu" aria-labelledby="dropdownMenu1">
                            <li><a href="{{route('genre')}}">Tâm Lý</a></li>
                        </ul>
                    </li>
                    <li class="header__nav-item">
                        <a class="header__nav-link" href="#" role="button" id="dropdownMenu1"
                        ...
                        <ul class="dropdown-menu header__nav-menu" aria-labelledby="dropdownMenu1">
                            <li><a href="{{route('country')}}">Mỹ</a></li>
                        </ul>
                    </li> 
                    <li class="header__nav-item">
                        <a class="header__nav-link" href="{{route('category')}}">Phim bộ</a>
                    </li>
                    <li class="header__nav-item">
                        <a class="header__nav-link" href="{{route('category')}}">Phim lẻ</a>
                    </li>
                    <li class="header__nav-item">
                        <a class="header__nav-link" href="{{route('category')}}">Phim thuyết minh</a>
                    </li>
                    <li class="header__nav-item">
                        <a class="header__nav-link" href="{{route('category')}}">Chiếu rạp</a>
                    </li>                   
                </ul>
