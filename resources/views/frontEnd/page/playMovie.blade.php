								...
								<div class="section__series owl-carousel" id="series">
									<div class="series">
										<a href="details.html" class="series__cover">
											<img src="{{asset('frontEnd')}}/img/series/1.jpg" alt="">
											<span>
									...
									<div class="series">
										<a href="details.html" class="series__cover">
											<img src="{{asset('frontEnd')}}/img/series/2.jpg" alt="">
											<span>
									...
									<div class="series">
										<a href="details.html" class="series__cover">
											<img src="{{asset('frontEnd')}}/img/series/3.jpg" alt="">
											<span>
									...
									<div class="series">
										<a href="details.html" class="series__cover">
											<img src="{{asset('frontEnd')}}/img/series/4.jpg" alt="">
											<span>
									...
									<div class="series">
										<a href="details.html" class="series__cover">
											<img src="{{asset('frontEnd')}}/img/series/5.jpg" alt="">
											<span>
									...
									<div class="series">
										<a href="details.html" class="series__cover">
											<img src="{{asset('frontEnd')}}/img/series/6.jpg" alt="">
											<span>
